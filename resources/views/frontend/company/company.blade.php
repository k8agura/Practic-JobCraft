...
<div class="unit-5 overlay" style="background-image: url({{ asset('external/images/hero_2.jpg') }})">
    <div class="container text-center">
      ...
      <p class="mb-0 unit-6"><a href="/">На главную</a> <span class="sep"> > <a href="{{ route('company') }}">Организации</a> </span> <span><span class="sep m-0"> ></span>Список</span></p>
    </div>
</div>
                ...
                <a class="d-block" href="{{ route('company.index', [$company->id,$company->slug]) }}">
                    <div class="card company-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('company.index', [$company->id,$company->slug]) }}" class="btn btn-primary">Узнать подробнее</a>
                        </div>
                    </div>
                </a>
            </div>
