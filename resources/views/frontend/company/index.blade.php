...
<div class="unit-5 overlay" style="background-image: url({{ asset('uploads/banner') }}/{{ $company->banner }});">
    <div class="container text-center">
      ...
      font-size: 2.5rem;">Компания:<strong>&nbsp;{{ $company->cname }}</strong></h1>
      <p class="mb-0 unit-6"><a href="/">На главную</a> <span class="sep"> > <a href="{{ route('alljobs') }}">Вакансии</a> </span> <span><span class="sep m-0"> ></span> О компании</span></p>
    </div>
</div>
    ...
    <div class="container">
            ...
            <div class="mb-4 mb-md-4 mr-5">
             <div class="job-post-item-header">
                <div class="d-flex align-items-center">
                    ...
                    <h3 class="mx-4 mb-0">Компания:<strong>&nbsp;{{ $company->cname }}</strong> </h3>

                </div>
                <p class="mt-3"><strong>О компании:</strong> &nbsp;{{ $company->description }}</p>
                <p><strong>Слоган:</strong>&nbsp;{{ $company->slogan }}</p>
                <p><strong>адрес:</strong>&nbsp;{{ $company->address }}</p>
                <p><strong>Телефон:</strong>&nbsp;{{ $company->phone }}</p>
                <p><strong>Веб-сайт: </strong>&nbsp;<a target="_blank" href="{{ $company->website }}">{{ $company->website }}</a></p>
      ...
      <div class="row">
        ...
        <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            <div class="p-4 bg-white">
            <h3 class="mb-5 h3">{{ $company->cname }} <i style="color: #28a745;" class="icon-hand-o-right"></i> другие вакансии</h3>
