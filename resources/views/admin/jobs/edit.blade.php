...
@section('content')
    ...
    <div class="content-header">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Редактировать вакансию : {{ $job->title }} </li>
            </ol>
        </nav>
                ...
                <div class="col-md-12">
                    @if (Session::has('message'))
                        <div class="alert alert-success mt-3 alert-dismissible fade show" role="alert">
                            <strong>Успешно!</strong> {{ Session::get('message') }}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <select class="form-control" name="gender">
                        ...
                        <option value="male"{{ $job->gender=='male' ? 'selected':'' }}>Только мужчины</option>
                        <option value="female"{{ $job->gender=='female' ? 'selected':'' }}>Только женщины</option>
