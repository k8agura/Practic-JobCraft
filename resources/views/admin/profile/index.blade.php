...
@section('content')
       ...
       <div class="content-header">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="material-icons">home</i>Кандидаты</a></li>
            
            <li class="breadcrumb-item active" aria-current="page">Кандидаты</li>
          </ol>
        </nav>
        <div class="create-item">
            <a href="#" class="theme-primary-btn btn btn-primary"><i class="material-icons">add</i>&nbsp;Создать нового кандидата</a>
                                          ...
                                          <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#candidateDelete-{{ $candidate->id }}" type="button"><i class="material-icons">delete</i></button>
                                            ...
                                            <div class="modal fade" id="candidateDelete-{{ $candidate->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel-{{ $candidate->id }}" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title text-center" id="staticBackdropLabel-{{ $candidate->id }}">Имя: {{ $candidate->name }}</h5>
