...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><h3 class="mt-1">{{ __('Регистрация компании') }}</h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('empl.register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="cname" class="col-md-4 col-form-label text-md-end">{{ __('Название компании') }}</label>
