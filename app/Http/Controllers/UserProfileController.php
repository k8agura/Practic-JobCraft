...
class UserProfileController extends Controller
{
    ...
    public function coverletter(Request $request){
        ...
        try{
            ...
            return redirect()->back()->with('success', 'Сопроводительное письмо обновлено');
        }catch(\Exception $e){
            return redirect()->back()->with('errors','Что-то пошло не так при загрузке файла!');
        }
    ...
    public function resume(Request $request){
        ...
        try{
            ...
            return redirect()->back()->with('success', 'Резюме успешно загружено.');
        }catch(\Exception $e){
            return redirect()->back()->with('errors','Что-то пошло не так при загрузке файла!');
        }
