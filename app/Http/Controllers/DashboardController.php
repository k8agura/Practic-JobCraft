...
class DashboardController extends Controller
{
    ...
    public function jobFetureToggle($id){
        ...
        return redirect('/dashboard/jobs')->with('success', 'Избранное успешно обновленно!');
    }
    ...
    public function jobToggle($id){
        ...
        return redirect('/dashboard/jobs')->with('success', 'Статус успешно обновлён!');
    }
    ...
    public function jobStore(JobPostRequest $request)
    {
        ...
        return redirect()->back()->with('success', 'Вакансия опубликована.');
    }
    ...
    public function jobRestore($id){
        ...
        return redirect('/dashboard/jobs')->with('success', 'Вакансия восстановлена!');
   }
    ...
    public function jobDeletePermanantly(Request $request){
        ...
        Job::onlyTrashed()->where('id', $id)->forceDelete();
         return redirect('/dashboard/jobs')->with('success', 'Вакансия удалена');
    }
    ...
    public function employerToggle($id){
        ...
        return redirect('/dashboard/employers')->with('success', 'Сатус успешно обновлён!');
    }
    ...
    public function updateEmployer(Request $request, string $id)
    {
        ...
        return redirect()->back()->with('success', 'Информация успешно обнавлена.');
    }
    ...
    public function destroyEmployer(Request $request){
        ...
        $employer->delete();
        return redirect('/dashboard/employers')->with('success', 'Компания успешно обновлена');
    }
    ...
    public function candidateToggle($id){
        ...
        return redirect('/dashboard/candidates')->with('success', 'Статус успешно обновлён!');
    }
    ...
    public function destroyCandidate(Request $request, string $id){
        ...
        return redirect('/dashboard/candidates')->with('success', 'Пользователь удалён!');
    }
    ...
    public function updateCategory(Request $request, $id){
        ...
        return redirect('/dashboard/category')->with('success', 'Категория успешно обновлена!');
    ...
    public function destroyCategory(Request $request, string $id){
        ...
        $Category->delete();
        return redirect('/dashboard/category')->with('success', 'Категория удалена!');
    }
    ...
    public function categoryToggle($id){
        ...
        return redirect('/dashboard/category')->with('success', 'Статус успешно обновлён!');
    }
    ...
    public function categoryStore(Request $request)
    {
        ...
        return redirect('/dashboard/category')->with('success', 'Категория создана успешно!');
    }
