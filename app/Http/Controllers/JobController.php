...
class JobController extends Controller
{
    ...
    {
        $this->middleware(['employer'], ['except'=> array('index', 'show', 'apply', 'allJobs', 'category', 'searchJobs')]);
    }
    ...
    public function store(JobPostRequest $request)
    {
        ...
        return redirect()->back()->with('success', 'Вакансия успешно опубликована.');
    }
    ...
    public function apply(Request $request,$id){
        ...
        return redirect()->back()->with('message', 'Отклик отрпавлен.');
    }
    ...
    public function jobToggle($id){
        ...
        return redirect('/jobs/myjobs')->with('success', 'Статус обновлён!');
    }
    ...
    public function deleteJob(Request $request, string $id){
        $jobDel = Job::find($id);
        $jobDel->delete();
        return redirect('/jobs/create')->with('success', 'Вакансия успешно удалена!');
    }
