                                          ...
                                          <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#employerDelete-<?php echo e($employer->id); ?>" type="button"><i class="material-icons">delete</i></button>
                                            ...
                                            <div class="modal fade" id="employerDelete-<?php echo e($employer->id); ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel-<?php echo e($employer->id); ?>" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title text-center" id="staticBackdropLabel-<?php echo e($employer->id); ?>">Компания: <?php echo e($employer->company->cname); ?></h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        <h4> Хотите удалить компанию?</h4>
                                                    </div>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/employers/index.blade.php ENDPATH**/ ?>