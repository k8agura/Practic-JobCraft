...
<div class="unit-5 overlay" style="background-image: url(<?php echo e(asset('external/images/hero_2.jpg')); ?>);">
  <div class="container text-center">
    ...
    <p class="mb-0 unit-6"><a href="/">На главную</a> <span class="sep"> > <a href="<?php echo e(route('alljobs')); ?>">Вакансии</a> </span> <span><span class="sep m-0"> ></span> Подробнее об вакансии</span></p>
  </div>
</div>
      ...
      <div class="col-lg-12">
        ...
        <div class="p-2 bg-white mb-2">
          <div class="alert alert-success mt-3 alert-dismissible fade show" role="alert">
              <strong>Это прекрасно !</strong> <?php echo e(Session::get('jobmsg')); ?>
        ...
        <div class="p-2 bg-white mb-2">
          <div class="alert alert-danger mt-3 alert-dismissible fade show" role="alert">
              <strong>Ошибка !</strong> <?php echo e(Session::get('error_msg')); ?>
      ...
      <div class="col-md-12 col-lg-8 mb-5">
        ...
        <div class="p-5 bg-white">
          ...
          <div class=" mb-8 bg-white">
            ...
            <p><?php echo e($job->number_of_vacancy); ?> откликнулось</p>
            
          </div>
          <div class=" mb-8 bg-white">
            <h3 class="h5 text-black mb-3"><i class="icon-clock-o" style="color: #28a745;">&nbsp;</i>Опыт</h3>
            <p><?php echo e($job->experience); ?>&nbsp;года работы</p>
      ...
      <div class="col-lg-4">
        ...
        <div class="p-4 mb-3 bg-white">
          <h3 class="h5 text-black mb-3">Кратко о вакансии</h3>
            <p>Название компании: <?php echo e($job->company->cname ?? ''); ?></p>
            <p>Адрес: <?php echo e($job->address); ?></p>
            <p>тип занятости: <?php echo e(Str::ucfirst($job->type)); ?></p>
            <p>Должность: <?php echo e(Str::ucfirst($job->position)); ?></p>
            <p>Опубликовано: <?php echo e($job->created_at->diffForHumans()); ?></p>
            <p>Крайний срок отклика: <?php echo e(date('F d, Y', strtotime($job->last_date))); ?></p>

            <p><a href="<?php echo e(route('company.index',[$job->company->id,$job->company->slug])); ?>" class="btn btn-warning" style="width: 100%;">Посетить веб-сайт компании</a></p>
        ...
        <div class="col-md-12 block-16" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="nonloop-block-16 owl-carousel">
            ...
            <div class="border rounded p-4 bg-white">
              ...
              <a href="<?php echo e(route('job.show', [$recommendJob->id, $recommendJob->slug])); ?>"><button class="btn btn-success btn-sm mt-4">Откликнуться</button></a>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/frontend/jobs/show.blade.php ENDPATH**/ ?>