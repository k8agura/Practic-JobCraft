                            ...
                            <tbody>
                                ...
                                <?php $i++; ?>
                                    <tr>
                                        ...
                                        &nbsp;<a class="btn btn-success btn-sm" href="<?php echo e(route('job.show', [$job->id, $job->slug])); ?>">Просмотреть</a>
                                            &nbsp;<a href="<?php echo e(route('job.edit', [$job->id])); ?>" class="btn btn-secondary btn-sm">Отредактировать</a>
                                            &nbsp;<button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#companyJobDelete-<?php echo e($job->id); ?>" type="button">Удалить</button>
                                            ...
                                            <div class="modal fade" id="companyJobDelete-<?php echo e($job->id); ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel-<?php echo e($job->id); ?>" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title text-center" id="staticBackdropLabel-<?php echo e($job->id); ?>">Название вакансии : <?php echo e($job->title); ?></h5>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/frontend/jobs/myjobs.blade.php ENDPATH**/ ?>