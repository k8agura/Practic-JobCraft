...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><h3 class="mt-1"><?php echo e(__('Регистрация компании')); ?></h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('empl.register')); ?>">
                        ...
                        <div class="row mb-3">
                            <label for="cname" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Название компании')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Ваш Email')); ?></label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    <?php echo e(__('Зарегистрировать компанию')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/auth/employer-register.blade.php ENDPATH**/ ?>