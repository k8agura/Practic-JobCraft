        ...
        <nav class="navbar navbar-expand-lg navbar-bg">
          ...
          <div class="brand-logo">
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>" id="menu-action">
              ...
              <span><?php echo e(config('app.adminName', 'Pactic/Job Craft админ')); ?></span>
            </a>    
...
<!--====== End Header Section======--><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views////admin/partials/navbar.blade.php ENDPATH**/ ?>