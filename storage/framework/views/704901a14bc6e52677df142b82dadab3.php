       ...
       <div class="content-header">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Редактировать : <?php echo e($candidate->name); ?></li>
          </ol>
        </nav>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <select class="form-control" name="gender">
                        <option value="any"<?php echo e($candidate->profile->gender ?? '' =='any' ? 'selected':''); ?>>Любой</option>
                        <option value="male"<?php echo e($candidate->profile->gender ?? '' =='male' ? 'selected':''); ?>>Мужчина</option>
                        <option value="female"<?php echo e($candidate->profile->gender ?? '' =='female' ? 'selected':''); ?>>Женщина</option>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/candidates/edit.blade.php ENDPATH**/ ?>