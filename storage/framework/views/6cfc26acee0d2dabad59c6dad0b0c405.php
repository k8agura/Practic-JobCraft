<?php $__env->startSection('content'); ?>
    ...
    <i class="material-icons text-white md-5em">favorite</i>
         ...
         <div class="row mt-3">
          ...
          <div class="col-md-4">
            <div class="card">
                <div class="card-header">Последние кандидаты</div>
        ...
        <div class="col-md-4">
          <div class="card">
              <div class="card-header">Последние работодатели</div>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\OSPanel\domains\JobFinder-Job-Portal-Laravel-Vue-Script-main\resources\views/admin/index.blade.php ENDPATH**/ ?>